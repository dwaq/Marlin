...
static volatile bool endstop_e_hit_min=false;
static volatile bool endstop_e_hit_max=false;
...
{
 if( endstop_x_hit || endstop_y_hit || endstop_z_hit || endstop_e_hit_min || endstop_e_hit_max) {
   SERIAL_ECHO_START;
   ...
   endstop_y_hit=false;
   endstop_z_hit=false;
   endstop_e_hit_min=false;
   endstop_e_hit_max=false;
#ifdef ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED
